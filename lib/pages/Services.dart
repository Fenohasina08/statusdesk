        ...
        child: ListView(
          ...
          children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              const Text('Services', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
              IconButton(onPressed: provider.isLoading ? null : () => context.read<ServiceProvider>().fetchServices(), icon: provider.isLoading ? const SizedBox(width: 22, height: 22, child: CircularProgressIndicator(strokeWidth: 2)) : const Icon(Icons.refresh, size: 27)),
            ]),
